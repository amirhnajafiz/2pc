...
//
// creating rpc services for transactions and paxos.
...
func (c *paxosClient) PrintBalance(ctx context.Context, in *PrintBalanceMsg, opts ...grpc.CallOption) (*PrintBalanceRsp, error) {
...
func (UnimplementedPaxosServer) PrintBalance(context.Context, *PrintBalanceMsg) (*PrintBalanceRsp, error) {
...
func _Paxos_PrintBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaxosServer).PrintBalance(ctx, req.(*PrintBalanceMsg))
	}
